	...
	function EditTradeDetail() {
		...
		if (confirm("거래명세서를 편집하시겠습니까?")) {
	        let data = {
				...
				prdSal :  document.getElementById("prdSal").value.replace(/,/g, ''),	
				prdCstPri :  document.getElementById("prdCstPri").value.replace(/,/g, ''),	
				prdMargin :	 document.getElementById("prdMargin").value,	
	        	recDedName: document.getElementById("recDedName").value,
	            recDed: document.getElementById("recDed").value.replace(/,/g, ''),
	            recDedSup: document.getElementById("recDedSup").value.replace(/,/g, ''),
	            recDedTax: document.getElementById("recDedTax").value.replace(/,/g, ''),
	            recDedCst: document.getElementById("recDedCst").value.replace(/,/g, ''),
	            recDedCstSup: document.getElementById("recDedCstSup").value.replace(/,/g, ''),
	            recDedCstTax: document.getElementById("recDedCstTax").value.replace(/,/g, ''),
	            recDedWorker: document.getElementById("worker").value,
	            recAddName: document.getElementById("recAddName").value,
	            recAdd: document.getElementById("recAdd").value.replace(/,/g, ''),
	            recAddSup: document.getElementById("recAddSup").value.replace(/,/g, ''),
	            recAddTax: document.getElementById("recAddTax").value.replace(/,/g, ''),
	            recAddCst: document.getElementById("recAddCst").value.replace(/,/g, ''),
	            recAddCstSup: document.getElementById("recAddCstSup").value.replace(/,/g, ''),
	            recAddCstTax: document.getElementById("recAddCstTax").value.replace(/,/g, ''),
